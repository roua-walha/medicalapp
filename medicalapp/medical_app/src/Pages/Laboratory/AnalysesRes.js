...
const AnalysesResl = () => {
  ...
  const handleClickResFunc = async (p,id_analyse) => {
    ...
    consultationOnlineContract.methods
                              .Add_Analyse_result(p,id_analyse,result,price)
                              .send({from: accounts[0]})
                            .then(() => alert('Analyse result add'))
                ...
                return (
                  <React.Fragment key={index}>
                    <tr>
                      ...
                      <td scope='row'>
                        <button id='butanal' onClick={handleClickRes}>Add</button>
                      </td>
                      <td scope='row'>
                        {analyse.price}
                      </td>
                        ...
                        <td colSpan='5'>
                          <div className="user-details">
                            <div className="input-box">
                              <span className="details">Result</span>
                              <input type="text" placeholder="Analyse result" required ref={resultInputRef} />
                            </div>
                          </div>
                        </td>
                      </tr>
                        ...
                        <td colSpan='5'>
                          <div className="user-details">
                            <div className="input-box">
                              ...
                              <input type="text" placeholder="Analyse Price" required ref={PriceInputRef} />
                            </div>
                            <div className="input-box">
                              <button id="butPr" onClick={() => handleClickResFunc(patientInfo.patient_add, analyse.id)}>Confirm</button>
                            </div>
                          </div>
                        </td>
                      </tr>
